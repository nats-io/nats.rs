...
use crate::Message;
use crate::new_client::connection::UserOp;
...
pub struct Subscription {
    ...
    sub_ops: mpsc::UnboundedSender<UserOp>,
}
...
impl Subscription {
    ...
    pub(crate) fn new(
        ...
        let _ = sub_ops.unbounded_send(UserOp::Sub {
...
impl Drop for Subscription {
    fn drop(&mut self) {
        ...
        let _ = self.sub_ops.unbounded_send(UserOp::Unsub {
            sid: self.sid,
            max_msgs: None,
        });
    }
