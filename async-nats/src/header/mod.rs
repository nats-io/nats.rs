...
//! used for interacting with `HeaderMap`.
//!
//! # `HeaderName`
//!
...
//! most commonly encountered when working with NATS. Standard header names are
...
//! cases common with NATS. It is a [multimap] structure, where each header name
